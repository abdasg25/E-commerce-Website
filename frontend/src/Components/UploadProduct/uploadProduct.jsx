...
const UploadProduct = ({ onClose, fetchData }) => {
  ...
  return (
    <div className='relative w-full h-full bg-slate-200 bg-opacity-35 top-0 left-0 right-0 bottom-0 flex justify-center items-center'>
...
{/* 
          ...
          <input 
            ...
            required
          />  
          <label htmlFor='shippingPrice' className='mt-3'>Shipping Price :</label>
          <input 
            type='number' 
            id='price' 
